	        ...
	        <main class="main">
	            <div class="col-lg-10 col-lg-offset-1">
	                            ...
	                            <div class="widget w-tags">
	                                <div class="tags-wrap ">
	                                    @foreach($post->tags as $tag)
		                                    <a href="{{ route('front.tags.show', ['id' => $tag->id])}}" class="w-tags-item">{{ $tag->name }}</a>
	                                    @endforeach
	                                </div>
	                            </div>
	                ...
	                <div class="pagination-arrow">
	                    ...
	                    @if($prev)
		                    <a href="{{ route('front.posts.show', ['slug' => $prev->slug]) }}" class="btn-prev-wrap">
		                        <svg class="btn-prev">
	                    ...
	                    @if($next)
		                    <a href="{{ route('front.posts.show', ['slug' => $next->slug]) }}" class="btn-next-wrap">
		                        <div class="btn-content">
...
@section('scripts')
	<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5a2a33eafaddb902"></script>
@endsection